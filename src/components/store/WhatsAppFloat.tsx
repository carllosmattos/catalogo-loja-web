...
export function WhatsAppFloat({ settings, message }: WhatsAppFloatProps) {
  ...
  return (
    <a
      ...
      className="fixed bottom-20 right-4 z-50 flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] text-white shadow-lg transition-transform hover:scale-105 active:scale-95 md:bottom-6 md:right-6"
