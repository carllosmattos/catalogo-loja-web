...
export default function PromocoesAdmin({
  ...
  useEffect(() => {
    if (section !== "cadastro" || promotions.length === 0) return;
  ...
  }, [section, promotions, searchParams]);
  ...
  return (
    <div>
      <h1 className="mb-6 text-2xl font-bold text-[var(--color-primary)]">
        {section === "lista" ? "Lista de promoções" : "Cadastro de promoções"}
      </h1>
      {section === "cadastro" && (
              ...
              >
                ...
                <div className="flex shrink-0 gap-2">
                  <AdminButton
                    variant="secondary"
                    onClick={() =>
                      router.push(`/admin/promocoes/cadastro?edit=${p.id}`)
                    }
                  >
                    Editar
                  </AdminButton>
