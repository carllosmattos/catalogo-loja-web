...
export default function AdminBrindesPage() {
  ...
  const [form, setForm] = useState({ name: "", stock: 0, purchase_price: 0, purchase_freight: 0, sale_markup: 0 });
  ...
  async function save(e: React.FormEvent) {
    e.preventDefault();
    await supabase.from("gifts").insert({ ...form, active: true, image_urls: [] });
    setForm({ name: "", stock: 0, purchase_price: 0, purchase_freight: 0, sale_markup: 0 });
    load();
  }
