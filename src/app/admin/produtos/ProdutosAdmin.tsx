  ...
  return (
    <div>
      <h1 className="mb-6 text-2xl font-bold text-[var(--color-primary)]">
        {section === "lista" ? "Lista de produtos" : "Cadastro de produtos"}
      </h1>
              ...
              {!editing ? (
                ...
                <div className="rounded-xl border border-gray-100 bg-gray-50 p-3">
                  ...
                  <p className="mt-2 text-xs text-gray-500">
                    Para alterar quantidade, use{" "}
                    <button
                      type="button"
                      className="underline"
                      onClick={() =>
                        router.push(
                          `/admin/produtos/estoque?id=${editing}`
                        )
                      }
                    >
                      Movimentar estoque
                  ...
                  >
                    ...
                    <div className="flex shrink-0 flex-wrap gap-2">
                      ...
                      <AdminButton
                        variant="secondary"
                        onClick={() =>
                          router.push(`/admin/produtos/estoque?id=${p.id}`)
                        }
                      >
                        Estoque
                      </AdminButton>
